...
@section('title', 'RakitPC - Rekomendasi Rakitan PC Cerdas')
    ...
    <div class="max-w-7xl mx-auto px-6 py-24 md:py-32 relative z-10">
        <div class="max-w-2xl">
            <span class="inline-block bg-sky-500/20 text-sky-300 text-sm font-semibold px-4 py-1.5 rounded-full mb-6 border border-sky-500/30">
                Powered by Expert System & DSS
            </span>
            <h1 class="text-4xl md:text-5xl font-extrabold text-white leading-tight mb-6">
                Rakit PC Impianmu, <span class="text-sky-400">Tanpa Ribet Mikir.</span>
            </h1>
            <p class="text-slate-300 text-lg mb-8 leading-relaxed">
                Cukup masukkan budget dan kebutuhanmu, sistem kami akan otomatis merekomendasikan kombinasi komponen PC yang kompatibel dan sesuai — tanpa perlu riset manual berjam-jam.
            </p>
...
<section class="max-w-7xl mx-auto px-6 -mt-24 relative z-20 pb-20">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white rounded-2xl shadow-lg p-8 border border-slate-100">
            ...
            <h3 class="text-lg font-bold text-slate-800 mb-2">Kompatibilitas Terjamin</h3>
            <p class="text-slate-500 text-sm leading-relaxed">Sistem otomatis mengecek kecocokan socket, tipe RAM, wattage, dan form factor setiap komponen.</p>
        </div>
        <div class="bg-white rounded-2xl shadow-lg p-8 border border-slate-100">
            <div class="w-14 h-14 bg-sky-100 rounded-xl flex items-center justify-center mb-5">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-sky-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <h3 class="text-lg font-bold text-slate-800 mb-2">Sesuai Budget</h3>
            <p class="text-slate-500 text-sm leading-relaxed">Alokasi cerdas berdasarkan kebutuhanmu — gaming, editing, atau office — tanpa melebihi budget.</p>
        </div>
        <div class="bg-white rounded-2xl shadow-lg p-8 border border-slate-100">
            <div class="w-14 h-14 bg-sky-100 rounded-xl flex items-center justify-center mb-5">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-sky-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <h3 class="text-lg font-bold text-slate-800 mb-2">Instan & Otomatis</h3>
            <p class="text-slate-500 text-sm leading-relaxed">Tidak perlu riset manual berjam-jam. Hasil rekomendasi lengkap dengan alasan pemilihan langsung tersedia.</p>
        </div>
    </div>
</section>
